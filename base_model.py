...
class BaseModel(object):
    def __init__(self, args, train, test):
        ...
        try: 
            ...
            sys.exit()
        self.train_loader = self.data.train_loader if train else None
        self.valid_loader = self.data.valid_loader if train else None
        self.test_loader = self.data.test_loader if test else None
